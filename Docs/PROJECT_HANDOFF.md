...
- Character creation, walkable exploration, world interactions, the separate battle-scene loop, the first job/roster data slice, reusable monster definitions, and speed-resolved battle rounds are complete locally.
