...
| `music_village_ambiance` | `Assets/ThirdParty/Audio/FreeStockMusic/village_ambiance_alexander_nakarada.mp3`; Suncrest Hollow theme candidate | Music | Alexander Nakarada (CreatorChords) / free-stock-music.com | CC BY 4.0 | Yes, with attribution | Yes under license | Credit and license notice required; do not distribute under the project's artist name | Exact credit in adjacent `ATTRIBUTION.md` | None stated | Adjacent attribution record, source URL, hash, and private original download | `Cleared` | Codex source-page review / 2026-07-23 |
| `music_off_to_war` | `Assets/ThirdParty/Audio/FreeStockMusic/off_to_war_alexander_nakarada.mp3`; Goblin Boss theme candidate | Music | Alexander Nakarada (CreatorChords) / free-stock-music.com | CC BY 4.0 | Yes, with attribution | Yes under license | Credit and license notice required; do not distribute under the project's artist name | Exact credit in adjacent `ATTRIBUTION.md` | None stated | Adjacent attribution record, source URL, hash, and private original download | `Cleared` | Codex source-page review / 2026-07-23 |
| `music_on_your_six` | `Assets/ThirdParty/Audio/FreeStockMusic/on_your_six_arthur_vyncke.wav`; standard battle theme candidate | Music | Arthur Vyncke / free-stock-music.com | CC BY-SA 3.0 Unported | Yes, with attribution | Keep unmodified pending derivative-work review | Credit and license notice required; adapted track must follow ShareAlike terms | Exact credit in adjacent `ATTRIBUTION.md` | None stated | Adjacent attribution record, source URL, hash, and private original archive | `Cleared` | Codex source-page review for unmodified use / 2026-07-23 |
| `music_epic_battle` | `Assets/ThirdParty/Audio/FreeStockMusic/epic_battle_fscm_productions.wav`; future boss theme candidate | Music | FSCM Productions / free-stock-music.com | CC BY 4.0 | Yes, with attribution | Yes under license | Credit and license notice required; do not distribute under the project's artist name | Exact credit in adjacent `ATTRIBUTION.md` | None stated | Adjacent attribution record, source URL, hash, and private original archive | `Cleared` | Codex source-page review / 2026-07-23 |
| `music_unburdening_feelings` | `Assets/ThirdParty/Audio/FreeStockMusic/unburdening_feelings_arthur_vyncke.wav`; main menu theme | Music | Arthur Vyncke / free-stock-music.com | CC BY-SA 3.0 Unported | Yes, with attribution | Keep unmodified pending derivative-work review | Credit and license notice required; adapted track must follow ShareAlike terms | Exact credit in adjacent `ATTRIBUTION.md` | None stated | Adjacent attribution record, source URL, hash, and private original archive | `Cleared` | Codex source-page review for unmodified use / 2026-07-23 |
